                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-color-tag">
                      ...
                      <a href="javascript:void(0)" class="aa-color-{{strtolower($attr->color)}} size_{{$attr->size}} product_color" onclick="change_product_color_image('{{asset('storage/media/'.$attr->attr_image)}}', '{{$attr->color}}')"></a>
                      @endif  
                    ...
                    <p class="text-danger add_to_cart_msg mt-2"></p>
                  </div>
                </div>
              </div>
            </div>
